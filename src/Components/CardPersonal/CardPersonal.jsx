...
export const CardPersonal = ({
  ...
  return (
    <div className="flex flex-col md:flex-row md:space-x-10 shadow-md shadow-neutral-700 p-2 md:p-0">
      <div className="w-[350px] md:w-[400px] ">
        <img src={"/" + url} alt="Proyecto1" className="bg-cover h-full" />
      </div>
      <div className="w-max h-full py-1">
        <div className="space-y-4">
          ...
          <div className="w-max grid grid-cols-3 xl:grid-cols-5 mx-auto">
            {herramientas.map((data, i) => {
              return (
                <div
                  className="w-[100px] h-[34px] rounded text-center px-1 py-1 hover:cursor-pointer mx-auto md:mx-0"
                  key={i}>
                  <h4 className="flex items-center gap-2 text-center md:text-left md:mt-0">
                    {renderIcono(data)}
                    {data}
                  </h4>
                </div>
